...
import Timescales from "../src/pages/Timescales";
import type { TimescalePhenomenon } from "../src/types/phenomena";
...
vi.mock("../src/hooks/useTimescalePhenomena", () => ({
...
vi.mock("../src/components/common/Headers", () => ({
  Navbar: () => <div data-testid="navbar" />,
}));

vi.mock("../src/components/timescales/PhenomenaComparator", () => ({
  PhenomenaComparator: () => <div>Comparator stub</div>,
}));

vi.mock("../src/components/timescales/GeoCosmicExplorer", () => ({
