...
import { GeoCosmicExplorer } from "../src/components/timescales/GeoCosmicExplorer";
import type { GeoExplorerData } from "../src/types/geological";

const mockUseGeologicalEras = vi.fn();

vi.mock("../src/hooks/useGeologicalEras", () => ({
